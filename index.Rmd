...
The small Herding Cats dataset is available [here.](https://github.com/AnnArborRUserGroup/BeginnerWorkshop/blob/master/data/herding-cats-small.csv)

The full Herding Cats dataset is available [here.](https://github.com/AnnArborRUserGroup/BeginnerWorkshop/blob/master/data/herding-cats.csv)

The Old Faithful dataset for the optional takehome is available [here.](https://github.com/AnnArborRUserGroup/BeginnerWorkshop/blob/master/data/Old-Faithful.csv)
